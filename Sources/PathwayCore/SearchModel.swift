...
public final class SearchModel {
    ...
    private static func describe(_ error: Error, entry: String) -> String {
        ...
        case ArchiveError.solidUnsupported:
            // Иначе ушло бы в default с «не удалось извлечь файл», где причина
            // не названа вовсе, — а она не в файле и не в поиске.
            "Непрерывный RAR-архив: системный распаковщик такие не поддерживает."
        default:
