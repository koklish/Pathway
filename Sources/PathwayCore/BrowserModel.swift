    ...
    private static func describe(_ error: any Error, at path: URL) -> String {
        if let archiveError = error as? ArchiveError {
            ...
            case .solidUnsupported:
                // С действием, как и остальные системные ошибки: сам по себе
                // «непрерывный архив» человеку ничего не говорит, а распаковать
                // его нечем — системный распаковщик такой режим не умеет вовсе.
                return "Непрерывный RAR-архив. Системный распаковщик такие не поддерживает — "
                    + "распакуйте через The Unarchiver или WinRAR."
